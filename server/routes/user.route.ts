...
import { activateUser, getAllUser, getUserInfo, loginUser, logoutUser, RegisterUser, socialAuth, udpateUserInfo, updateaccessToken, updatePassword, updateProfilePicture } from '../controllers/user.controller'
