import { useAddAnswerInQuestionMutation, useAddNewQuestionMutation, useAddReplyInReviewMutation, useAddReviewInCourseMutation, useGetCourseDetailsQuery } from '@/app/redux/features/courses/coursesApi';
                ...
                <div className="w-full">
                    <>
                        ...
                        <div className="w-full">
                            {course?.reviews &&
                                [...course.reviews]
                                    .filter((rev: any) => rev.contentId === data[activeVideo]._id)
                                    .reverse()
